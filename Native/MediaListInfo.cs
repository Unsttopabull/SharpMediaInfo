...
namespace Frost.SharpMediaInfo.Native {
    public static class MediaListInfo {
        ...
        [DllImport("x86/MediaInfo.dll", EntryPoint = "MediaInfoList_Open")]
        public static extern IntPtr Open(IntPtr handle, [MarshalAs(UnmanagedType.LPWStr)] string fileName, IntPtr options);

        [DllImport("x86/MediaInfo.dll", EntryPoint = "MediaInfoList_New")]
        public static extern IntPtr New();

        [DllImport("x86/MediaInfo.dll", EntryPoint = "MediaInfoList_Delete")]
        public static extern void Delete(IntPtr handle);

        [DllImport("x86/MediaInfo.dll", EntryPoint = "MediaInfoList_Close")]
        public static extern void Close(IntPtr handle, IntPtr filePos);

        [DllImport("x86/MediaInfo.dll", EntryPoint = "MediaInfoList_Inform")]
        public static extern IntPtr Inform(IntPtr handle, IntPtr filePos, IntPtr reserved);

        [DllImport("x86/MediaInfo.dll", EntryPoint = "MediaInfoList_GetI")]
        ...
        [DllImport("x86/MediaInfo.dll", EntryPoint = "MediaInfoList_Get")]
        ...
        [DllImport("x86/MediaInfo.dll", EntryPoint = "MediaInfoList_Option")]
        ...
        [DllImport("x86/MediaInfo.dll", EntryPoint = "MediaInfoList_State_Get")]
        public static extern IntPtr StateGet(IntPtr handle);

        [DllImport("x86/MediaInfo.dll", EntryPoint = "MediaInfoList_Count_Get")]
